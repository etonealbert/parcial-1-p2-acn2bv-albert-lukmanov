...
<body class="tema-<?php echo htmlspecialchars($tema); ?>">
    ...
    <script>
            ...
            return `
                <article class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge">🏷️ ${item.categoria}</span>
        ...
        limpiarBtn.addEventListener('click', function () {
            filtrosForm.reset();
            filtrosForm.querySelector('input[name="tema"]').value = '<?php echo htmlspecialchars($tema); ?>';
            cargarItems();
            window.history.replaceState({}, '', window.location.pathname + '?tema=<?php echo htmlspecialchars($tema); ?>');
        });
